...
public class RedirectStudentPanel extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if (session != null && "student".equals(session.getAttribute("role"))) {
            ...
            String sidStr = (String) req.getAttribute("sid");
            ...
            System.out.println("hellooooo " + id + " " + sid);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        // You can reuse the doGet logic for POST requests
        doGet(req, res);
    }
    ...
    public List<String> selectCoursesByStudentId(int studentId, Connection conn) {
        ...
        try {
            ...
            while (rs2.next()) {
                courses.add(rs2.getString("course"));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        } finally {
